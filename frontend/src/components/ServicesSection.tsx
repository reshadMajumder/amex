  ...
  return (
    <section className="py-20 bg-gray-50/50">
      <div className="container mx-auto px-4">
        ...
        <div 
          className="grid md:grid-cols-2 gap-8 items-start transition-all duration-300"
          style={{
            gridTemplateColumns: hoveredCard ? (hoveredCard === 'individual' ? '2fr 1fr' : '1fr 2fr') : '1fr 1fr'
          }}
            ...
            <div className="relative h-auto md:h-[32rem] p-8 flex flex-col justify-start">
                ...
                <div className="relative z-10 w-full h-full">
                    ...
                    <div className="relative w-full h-[calc(100%-4rem)]">
                        {/* List View */}
                        <div className={cn("transition-opacity duration-300", hoveredCard === 'individual' ? "opacity-0 -z-10" : "opacity-100")}>
                        ...
                        {/* Grid View on Hover */}
                         <div className={cn("absolute inset-0 transition-opacity duration-300", hoveredCard === 'individual' ? "opacity-100" : "opacity-0 -z-10")}>
          ...
          <Card className={cn(
            ...
            >
             <div className="relative h-auto md:h-[32rem] flex flex-col justify-start">
                 <div className={cn("absolute inset-0 transition-opacity duration-500", hoveredCard === 'enterprise' ? "opacity-100" : "opacity-0 group-hover:opacity-100")}>
                ...
                {enterpriseBg && ! (hoveredCard === 'enterprise') &&
                    <Image 
                ...
                <div className={cn("absolute inset-0 bg-gradient-to-r from-white via-white/80 to-transparent", hoveredCard === 'enterprise' ? "opacity-0" : "opacity-100")}></div>
                 <div className="absolute inset-0 bg-gradient-to-t from-white/80 to-transparent"></div>

                <div className="relative z-10 p-8 h-full">
                    <div className={cn(hoveredCard === 'enterprise' ? 'pt-28': '')}>
                        <div className={cn(hoveredCard === 'enterprise' ? 'opacity-0 -z-10' : 'opacity-100 transition-opacity')}>
                            <div className="relative">
                                ...
                                <ul className="space-y-3 mt-4">
                                    {enterpriseServicesList.map((service) => (
                                        <li key={service} className="flex items-center">
                                            <span className="h-2 w-2 bg-red-500 rounded-full mr-3"></span>
                                            <span className="text-gray-700">{service}</span>
                                        </li>
                     ...
                     <div className={cn("absolute inset-0 top-28 p-8 transition-opacity duration-300", hoveredCard === 'enterprise' ? "opacity-100" : "opacity-0 -z-10")}>
